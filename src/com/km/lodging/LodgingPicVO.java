...
public class LodgingPicVO {
	private int lodging_seq;
	private String lodging_pic_path;
	private String lodging_pic_oriname;  
	private String 	lodging_pic_rename;
	private String lodging_pic_typical;
	...
	public String getLodging_pic_path() {
		return lodging_pic_path;
	}
	...
	public String getLodging_pic_typical() {
		return lodging_pic_typical;
	}
	public void setLodging_pic_typical(String lodging_pic_typical) {
		this.lodging_pic_typical = lodging_pic_typical;
	}
